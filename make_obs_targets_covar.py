...
CERES = '../HadCM3-CMIP6/data/Observations/CERES/CERES_EBAF-TOA_Ed4.1_Subset_200003-202105_N48.nc'
CRU_TS_precip = '../HadCM3-CMIP6/data/Observations/CRU_TS/cru_ts4.05.2011.2020.pre.dat_N48_land.nc'
CRU_TS_temp = '../HadCM3-CMIP6/data/Observations/CRU_TS/cru_ts4.05.2011.2020.tmp.dat_N48_land.nc'# VN 4.05 temp looks suspect
ERA5_free_atmos = '../HadCM3-CMIP6/data/Observations/ERA5/ERA5_500hPa_RH_T_mon_2010_2019_N48.nc'
ERA5_sfc = '../HadCM3-CMIP6/data/Observations/ERA5/ERA5_sfc_mon_2010_2020_N48.nc'
ERA5_sfc_land = '../HadCM3-CMIP6/data/Observations/ERA5/ERA5_sfc_mon_2010_2020_N48_land.nc'
NCEP_mslp = '../HadCM3-CMIP6/data/Observations/NCEP2/mslp.mon.mean_N48.nc'
NCEP_rh = '../HadCM3-CMIP6/data/Observations/NCEP2/rhum_500.mon.mean_N48.nc'
NCEP_T = '../HadCM3-CMIP6/data/Observations/NCEP2/air_500.mon.mean_N48.nc'
MODIS = '../HadCM3-CMIP6/data/Observations/MODIS/MODIS_AQUA_Reff_N48.nc'
GPCC = '../HadCM3-CMIP6/data/Observations/GPCC/full_data_monthly_v2020_2011_2019_025_N48_land.nc'
BEST = '../HadCM3-CMIP6/data/Observations/BEST/Complete_TAVG_LatLong1_fix_N48_land.nc'
...
rewrite_rules[CERES] = dict(toa_sw_all_mon='RSR', toa_lw_all_mon='OLR',
                            ...
                            toa_sw_clr_c_mon='SWC', toa_lw_clr_c_mon='LWC',
                            )
